    ...
    public partial class AddBook : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "SeriesName", "SeriesNumber", "Title", "UserId" },
                values: new object[] { 1, "BookAuthor", "BookSeriesName", 1, "BookTitle", " " });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "SeriesName", "SeriesNumber", "Title", "UserId" },
                values: new object[] { 2, "BookAuthor", "BookSeriesName", 2, "BookTitle2", " " });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "SeriesName", "SeriesNumber", "Title", "UserId" },
                values: new object[] { 3, "BookAuthor", "BookSeriesName", 3, "BookTitle3", " " });
